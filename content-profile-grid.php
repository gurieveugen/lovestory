<div class="profile-preview">
	...
	<div class="profile-text">
		...
		<p>
			<?php 
				$prof = ThemexUser::getExcerpt(ThemexUser::$data['active_user']['profile']); 
				$prof = str_replace( 'years old',',',$prof);
				$prof = str_replace( 'man from','man,',$prof);
				$prof = str_replace( 'woman from','woman,',$prof);
				echo $prof;
			?>
		</p>
	</div>
