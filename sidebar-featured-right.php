<div id="featured-right">
	...
	<?php 
		$profiles_featured = ThemexUser::selectBoostVisibility(ThemexUser::$data['user']['profile']['city'], ThemexUser::$data['user']['profile']['country'], ThemexUser::$data['user']['ID'], 'woman', 4); 
