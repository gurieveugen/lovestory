<aside class="column threecol">	
	...
	<form class="formatted-form" id="formatted-form_left" action="" method="POST">
		<table class="profile-fields">
			<tbody>
                ...
                <tr>
					...
					<td>
						<div class="field-wrap">
							<input type="text" name="height-in-cm" size="50" value="<?php echo ThemexUser::$data['user']['profile']['height-in-cm']; ?>" />
						</div>
					</td>
				</tr>
                <tr>
					...
					<td>
						<div class="field-wrap">
							<input type="text" name="weight-in-kilos" size="50" value="<?php echo ThemexUser::$data['user']['profile']['weight-in-kilos']; ?>" />
						</div>
					</td>
				</tr>
                <tr>
					<th><?php _e('Wants to Meet', 'lovestory'); ?></th>
					<td>
						<div class="field-wrap">
							<input type="text" name="wants-to-meet" size="50" value="<?php echo ThemexUser::$data['user']['profile']['wants-to-meet']; ?>" />
						</div>
					</td>
				</tr>
				<?php } ?>
		...
		<div class="profile-description">
            ...
            <textarea name="description" id="description" placeholder="Description"><?php echo str_replace('+',' ',ThemexUser::$data['user']['profile']['description']);?></textarea>
		</div>		
